  ...
  return (
    <section className="bg-black">
      <main className="container py-8 px-4 sm:px-6 lg:px-12 max-w-[1400px] mx-auto">
        ...
        <div className="md:min-h-screen flex text-white px-4 py-36 md:px-6 lg:px-8">
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              {t("kamiAdalah")}
              <span className="block">{t("orangVisioner")}</span>
              <span className="block">{t("orangProfessional")}</span>
            </motion.h1>
            {/* Animated Section */}
            <div className="bg-black text-white flex flex-col items-start md:justify-between md:py-32 border-b border-white/20 md:p-16">
              {/* Animated Content */}
              <motion.div
              ...
              >
                <div className="md:flex flex flex-row-reverse py-4 md:py-0 md:flex-row md:gap-12 items-start">
                  ...
                  <motion.div
                    ...
                    className="md:flex-1 text-md md:text-2xl md:leading-relaxed space-y-6"
                  >
                    <p>{t("perkenalanDesc1")}</p>
                  </motion.div>
                </div>
              </motion.div>
            </div>
